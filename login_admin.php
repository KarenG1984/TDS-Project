...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($username_err) && empty($password_err)) {
    ...
    $sql = "SELECT id, username, password FROM registro_facilitador WHERE username = ?";
...
<body>
  ...
  <section class="login">
    <div class="login__content">
      ...
      <p class="login__content--register">¿Aún no tienes una cuenta? <a href="./signup_admin.php">Regístrate</a></p>
    </div>
  </section>
